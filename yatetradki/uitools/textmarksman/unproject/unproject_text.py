...
from yatetradki.uitools.textmarksman.unproject import ellipse
...
def unproject(src, dest):
    ...
    cv2.imwrite(dest, DEBUG_IMAGES[-1])
...
def main():
    ...
    cv2.imwrite(sys.argv[2], DEBUG_IMAGES[-1])
